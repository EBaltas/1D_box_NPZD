...
#            print("zdep = ", zdep[ilay])
#            print("Ibase = ", Ibase[ilay-1])
#            print("Ibase - 1 = ", Ibase[ilay])
#            print("kPAR = ", kPAR[ilay])
#            print("alpha = ", alpha_bio)
#            print("VpT = ", VpT)
#            print("daylnow = ", daylnow)
#            print("flag_PIcurve = ", flag_PIcurve)
#            print("flag_irrad = ", flag_irrad)
...
print("Annual fluxes (last year): P N Z D")
print(fluxyear)

#fluxvar <- colSums(fluxyear)    # fluxes for each state var summed over year
fluxvar = np.sum(fluxyear, axis=0)
...
Heat_d = [0]
Heat_ab = [0]
NTOA = [0]  #heat flux at top of atmosphere
N = [0]  # planetary heat uptake
DTa = [0]
DTm = [0]
DTm_year = [0]
DTd = [0]
...
for iyear in range(0, nyears):  # trying to restructure loop so that we first loop of the years - this is because the biological model and physical model communicate with each other after each year
    ...
    for kday in range(1, 366):  # trying to loop over all the days of the year and get the same resutls for the physical model
            ...
            #t_vent_phys.append(t_vent_phys[0]/(1 - DTm[iyear*365 + kday -1]/Tref*30))
            t_vent1_phys.append(t_vent1_phys[0])
            t_vent2_phys.append(t_vent2_phys[0])
            
            # heat budget
            DR.append(alpha*(math.log(chi[iyear*365 + kday]/chi[0])))
            NTOA.append((DR[iyear*365 + kday] - lamda*DTa[iyear*365 + kday -1]))  # planetary heat uptake
            Natm.append(CC*(DTa[iyear*365 + kday -1] - DTm[iyear*365 + kday -1]))   # heat flux from atmosphere to ocean
...
df_dic_ab.columns = ['x1','dic_ab_tventconst']
#print(df_dic_d)
...
df_DTd.columns = ['x2','DTd_tventconst']
#print(df_DTd)

df_DTab = pd.DataFrame(data=[x2, DTab]).T
df_DTab.columns = ['x2','DTab_tventconst']
...
df_Pgrow.columns = ['x1','Pgrow_tventconst']

df_Pgraz = pd.DataFrame(data=[x1, Pgraz]).T
df_Pgraz.columns = ['x1','Pgraz_tventconst']

df_Pmort = pd.DataFrame(data=[x1, Pmort]).T
df_Pmort.columns = ['x1','Pmort_tventconst']

df_Pmort2 = pd.DataFrame(data=[x1, Pmort2]).T
df_Pmort2.columns = ['x1','Pmort2_tventconst']

df_Pmix = pd.DataFrame(data=[x1, Pmix]).T
df_Pmix.columns = ['x1','Pmix_tventconst']

df_Pdilute = pd.DataFrame(data=[x1, Pdilute]).T
df_Pdilute.columns = ['x1','Pdilute_tventconst']

df_Nmix = pd.DataFrame(data=[x1, Nmix]).T
df_Nmix.columns = ['x1','Nmix_tventconst']

df_Zexc = pd.DataFrame(data=[x1, Zexc]).T
df_Zexc.columns = ['x1','Zexc_tventconst']

df_Dremin_src = pd.DataFrame(data=[x1, Dremin_src]).T
df_Dremin_src.columns = ['x1','Dremin_src_tventconst']

df_Pgrow_sink = pd.DataFrame(data=[x1, Pgrow_sink]).T
df_Pgrow_sink.columns = ['x1','Pgrow_sink_tventconst']

df_Nadd = pd.DataFrame(data=[x1, Nadd]).T
df_Nadd.columns = ['x1','Nadd_tventconst']

df_Ndilute = pd.DataFrame(data=[x1, Ndilute]).T
df_Ndilute.columns = ['x1','Ndilute_tventconst']

df_Zgrow = pd.DataFrame(data=[x1, Zgrow]).T
df_Zgrow.columns = ['x1','Zgrow_tventconst']

df_Zmort = pd.DataFrame(data=[x1, Zmort]).T
df_Zmort.columns = ['x1','Zmort_tventconst']

df_Zmort2 = pd.DataFrame(data=[x1, Zmort2]).T
df_Zmort2.columns = ['x1','Zmort2_tventconst']

df_Zdilute = pd.DataFrame(data=[x1, Zdilute]).T
df_Zdilute.columns = ['x1','Zdilute_tventconst']

df_Zmix = pd.DataFrame(data=[x1, Zmix]).T
df_Zmix.columns = ['x1','Zmix_tventconst']

df_Pmort_src = pd.DataFrame(data=[x1, Pmort_src]).T
df_Pmort_src.columns = ['x1','Pmort_src_tventconst']

df_Pmort2_src = pd.DataFrame(data=[x1, Pmort2_src]).T
df_Pmort2_src.columns = ['x1','Pmort2_src_tventconst']

df_Zmort_src = pd.DataFrame(data=[x1, Zmort_src]).T
df_Zmort_src.columns = ['x1','Zmort_src_tventconst']

df_Zpel = pd.DataFrame(data=[x1, Zpel]).T
df_Zpel.columns = ['x1','Zpel_tventconst']

df_Dgraz = pd.DataFrame(data=[x1, Dgraz]).T
df_Dgraz.columns = ['x1','Dgraz_tventconst']

df_Dmix = pd.DataFrame(data=[x1, Dmix]).T
df_Dmix.columns = ['x1','Dmix_tventconst']

df_Dsink = pd.DataFrame(data=[x1, Dsink]).T
df_Dsink.columns = ['x1','Dsink_tventconst']

df_Dremin = pd.DataFrame(data=[x1, Dremin]).T
df_Dremin.columns = ['x1','Dremin_tventconst']

df_Ddilute = pd.DataFrame(data=[x1, Ddilute]).T
df_Ddilute.columns = ['x1','Ddilute_tventconst']
...
df_t_vent1_phys.columns = ['x2','t_vent1_phys_tventconst']

df_t_vent2_phys = pd.DataFrame(data=[x2, t_vent2_phys]).T
df_t_vent2_phys.columns = ['x2','t_vent2_phys_tventconst']
...
df_Delta_Id_DIC.to_csv("Results/Delta_Id_DIC_tventconst.csv", index=None)

df_Delta_Im_DIC.to_csv("Results/Delta_Im_DIC_tventconst.csv", index=None)

df_Delta_Iab_DIC.to_csv("Results/Delta_Iab_DIC_tventconst.csv", index=None)

df_Delta_Im_DIC_bio.to_csv("Results/Delta_Im_DIC_bio_tventconst.csv", index=None)

df_Delta_Id_DIC_bio.to_csv("Results/Delta_Id_DIC_bio_tventconst.csv", index=None)

df_Delta_Iab_DIC_bio.to_csv("Results/Delta_Iab_DIC_bio_tventconst.csv", index=None)

df_Ibelow_DOC.to_csv("Results/Ibelow_DOC_tventconst.csv", index=None)

df_Im_DOC.to_csv("Results/Im_DOC_tventconst.csv", index=None)

df_Delta_Ibelow_DOC.to_csv("Results/Delta_Ibelow_DOC_tventconst.csv", index=None)

df_Delta_Im_DOC.to_csv("Results/Delta_Im_DOC_tventconst.csv", index=None)

#df_I_DOC.to_csv("Results/I_DOC_tvent1.csv", index=None)
#df_I_DOC.to_csv("Results/I_DOC_tvent2.csv", index=None)
df_Delta_I_DOC.to_csv("Results/Delta_I_DOC_tventconst.csv", index=None)

#df_I_DIC.to_csv("Results/I_DIC_tvent1.csv", index=None)
#df_I_DIC.to_csv("Results/I_DIC_tvent2.csv", index=None)
df_Delta_I_DIC.to_csv("Results/Delta_I_DIC_tventconst.csv", index=None)

#df_Ia.to_csv("Results/Ia_tvent1.csv", index=None)
#df_Ia.to_csv("Results/Ia_tvent2.csv", index=None)
df_Delta_Ia.to_csv("Results/Delta_Ia_tventconst.csv", index=None)

df_delta_temp.to_csv("Results/delta_temp_tventconst.csv", index=None)
...
df_dic_ab.to_csv("Results/dic_ab_tventconst.csv", index=None)
...
df_DTab.to_csv("Results/DTab_tventconst.csv", index=None)
...
df_Pgrow.to_csv("Results/Pgrow_tventconst.csv", index=None)

df_Pgraz.to_csv("Results/Pgraz_tventconst.csv", index=None)

df_Pmort.to_csv("Results/Pmort_tventconst.csv", index=None)

df_Pmort2.to_csv("Results/Pmort2_tventconst.csv", index=None)

df_Pmix.to_csv("Results/Pmix_tventconst.csv", index=None)

df_Pdilute.to_csv("Results/Pdilute_tventconst.csv", index=None)

df_Nmix.to_csv("Results/Nmix_tventconst.csv", index=None)

df_Zexc.to_csv("Results/Zexc_tventconst.csv", index=None)

df_Dremin_src.to_csv("Results/Dremin_src_tventconst.csv", index=None)

df_Pgrow_sink.to_csv("Results/Pgrow_sink_tventconst.csv", index=None)

df_Nadd.to_csv("Results/Nadd_tventconst.csv", index=None)

df_Ndilute.to_csv("Results/Ndilute_tventconst.csv", index=None)

df_Zgrow.to_csv("Results/Zgrow_tventconst.csv", index=None)

df_Zmort.to_csv("Results/Zmort_tventconst.csv", index=None)

df_Zmort2.to_csv("Results/Zmort2_tventconst.csv", index=None)

df_Zdilute.to_csv("Results/Zdilute_tventconst.csv", index=None)

df_Zmix.to_csv("Results/Zmix_tventconst.csv", index=None)

df_Pmort_src.to_csv("Results/Pmort_src_tventconst.csv", index=None)

df_Pmort2_src.to_csv("Results/Pmort2_src_tventconst.csv", index=None)

df_Zmort_src.to_csv("Results/Zmort_src_tventconst.csv", index=None)

df_Zpel.to_csv("Results/Zpel_tventconst.csv", index=None)

df_Dgraz.to_csv("Results/Dgraz_tventconst.csv", index=None)

df_Dmix.to_csv("Results/Dmix_tventconst.csv", index=None)

df_Dsink.to_csv("Results/Dsink_tventconst.csv", index=None)

df_Dremin.to_csv("Results/Dremin_tventconst.csv", index=None)

df_Ddilute.to_csv("Results/Ddilute_tventconst.csv", index=None)
...
df_t_vent1_phys.to_csv("Results/t_vent1_phys_tventconst.csv", index=None)

df_t_vent2_phys.to_csv("Results/t_vent2_phys_tventconst.csv", index=None)
