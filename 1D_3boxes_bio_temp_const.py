...
# -*- coding: utf-8 -*-
"""
Created on Wed Oct 11 15:01:35 2023
...
for iyear in range(0, nyears):  # trying to restructure loop so that we first loop of the years - this is because the biological model and physical model communicate with each other after each year
    ...
    #t_vent_bio.append(t_vent + 50*t_vent*(((h_m*(DTm_year[iyear]) + h_d*(DTd_year[iyear]))/(h_m + h_d)) - (DTab_year[iyear]))/Tref)
    ...
    for kday in range(1, 366):  # trying to loop over all the days of the year and get the same resutls for the physical model
            ...
            #t_vent1_phys.append(tc1 + 50*tc1*(((h_m*(DTm[iyear*365 + kday -1]) + h_d*(DTd[iyear*365 + kday -1]))/(h_m + h_d)) - (DTab[iyear*365 + kday -1]))/Tref)
...
print("E-folding = ", (math.exp(-delta_t/t_vent_bio[0]) - 1))
...
df_Delta_Id_DIC.columns = ['x1','Delta_Id_DIC_tempconst']

df_Delta_Im_DIC = pd.DataFrame(data=[x1, Delta_Im_DIC]).T
df_Delta_Im_DIC.columns = ['x1','Delta_Im_DIC_tempconst']

df_Delta_Iab_DIC = pd.DataFrame(data=[x1, Delta_Iab_DIC]).T
df_Delta_Iab_DIC.columns = ['x1','Delta_Iab_DIC_tempconst']

df_Delta_Im_DIC_bio = pd.DataFrame(data=[x1, Delta_Im_DIC_bio]).T
df_Delta_Im_DIC_bio.columns = ['x1', 'Delta_Im_DIC_bio_tempconst']

df_Delta_Id_DIC_bio = pd.DataFrame(data=[x1, Delta_Id_DIC_bio]).T
df_Delta_Id_DIC_bio.columns = ['x1', 'Delta_Id_DIC_bio_tempconst']

df_Delta_Iab_DIC_bio = pd.DataFrame(data=[x1, Delta_Iab_DIC_bio]).T
df_Delta_Iab_DIC_bio.columns = ['x1', 'Delta_Iab_DIC_bio_tempconst']

df_Ibelow_DOC = pd.DataFrame(data=[x1, Ibelow_DOC]).T
df_Ibelow_DOC.columns = ['x1','Ibelow_DOC_tempconst']

df_Delta_Ibelow_DOC = pd.DataFrame(data=[x1, Delta_Ibelow_DOC]).T
df_Delta_Ibelow_DOC.columns = ['x1','Delta_Ibelow_DOC_tempconst']

df_Im_DOC = pd.DataFrame(data=[x1, Im_DOC]).T
df_Im_DOC.columns = ['x1','Im_DOC_tempconst']

df_Delta_Im_DOC = pd.DataFrame(data=[x1, Delta_Im_DOC]).T
df_Delta_Im_DOC.columns = ['x1','Delta_Im_DOC_tempconst']

df_Delta_I_DOC = pd.DataFrame(data=[x1,Delta_I_DOC]).T
#df_I_DOC.columns = ['x1','I_DOC_tvent1']
df_Delta_I_DOC.columns = ['x1','Delta_I_DOC_tempconst']
#print(df_I_DOC)

df_Delta_I_DIC = pd.DataFrame(data=[x1,Delta_I_DIC]).T
#df_I_DIC.columns = ['x1','I_DIC_tvent1']
df_Delta_I_DIC.columns = ['x1','Delta_I_DIC_tempconst']
#print(df_I_DIC)

df_Delta_Ia = pd.DataFrame(data=[x1,Delta_Ia_year]).T
#df_Ia.columns = ['x1','Ia_tvent1']
df_Delta_Ia.columns = ['x1','Delta_Ia_tempconst']
#print(df_Ia)

df_delta_temp = pd.DataFrame(data=[x1, delta_temp]).T
df_delta_temp.columns = ['x1', 'delta_temp_tempconst']

df_dic_m = pd.DataFrame(data=[x1,dic_m_year]).T
#df_dic_m.columns = ['x1','dic_m_tvent1']
df_dic_m.columns = ['x1','dic_m_tempconst']
#print(df_dic_m)

df_dic_d = pd.DataFrame(data=[x1,dic_d_year]).T
#df_dic_d.columns = ['x1','dic_d_tvent1']
df_dic_d.columns = ['x1','dic_d_tempconst']
#print(df_dic_d)

df_dic_ab = pd.DataFrame(data=[x1,dic_ab_year]).T
#df_dic_d.columns = ['x1','dic_d_tvent1']
df_dic_ab.columns = ['x1','dic_ab_tempconst']
#print(df_dic_ab)

df_DTa = pd.DataFrame(data=[x2,DTa]).T
#df_DTa.columns = ['x2','DTa_tvent1']
df_DTa.columns = ['x2','DTa_tempconst']
#print(df_DTa)

df_DTm = pd.DataFrame(data=[x2,DTm]).T
#df_DTm.columns = ['x2','DTm_tvent1']
df_DTm.columns = ['x2','DTm_tempconst']
#print(df_DTm)

df_DTd = pd.DataFrame(data=[x2,DTd]).T
#df_DTd.columns = ['x1','DTd_tvent1']
df_DTd.columns = ['x2','DTd_tempconst']
#print(df_DTd)

df_DTab = pd.DataFrame(data=[x2,DTab]).T
df_DTab.columns = ['x2','DTab_tempconst']

df_Delta_Pgrow = pd.DataFrame(data=[x1, Delta_Pgrow]).T
#df_Delta_Pgrow.columns = ['x1','Delta_Pgrow_tvent1']
df_Delta_Pgrow.columns = ['x1','Delta_Pgrow_tempconst']

df_Delta_Zgrow = pd.DataFrame(data=[x1, Delta_Zgrow]).T
#df_Delta_Zgrow.columns = ['x1','Delta_Zgrow_tvent1']
df_Delta_Zgrow.columns = ['x1','Delta_Zgrow_tempconst']

df_Delta_Dremin = pd.DataFrame(data=[x1, Delta_Dremin]).T
#df_Delta_Dremin.columns = ['x1','Delta_Dremin_tvent1']
df_Delta_Dremin.columns = ['x1','Delta_Dremin_tempconst']

df_Delta_Nmix = pd.DataFrame(data=[x1, Delta_Nmix]).T
#df_Delta_Nmix.columns = ['x1','Delta_Nmix_tvent1']
df_Delta_Nmix.columns = ['x1','Delta_Nmix_tempconst']

df_Delta_Pmix = pd.DataFrame(data=[x1, Delta_Pmix]).T
#df_Delta_Pmix.columns = ['x1','Delta_Pmix_tvent1']
df_Delta_Pmix.columns = ['x1','Delta_Pmix_tempconst']

df_Delta_Zmix = pd.DataFrame(data=[x1, Delta_Zmix]).T
#df_Delta_Zmix.columns = ['x1','Delta_Zmix_tvent1']
df_Delta_Zmix.columns = ['x1','Delta_Zmix_tempconst']

df_Delta_Dmix = pd.DataFrame(data=[x1, Delta_Dmix]).T
#df_Delta_Dmix.columns = ['x1','Delta_Dmix_tvent1']
df_Delta_Dmix.columns = ['x1','Delta_Dmix_tempconst']

df_Delta_Dsink = pd.DataFrame(data=[x1, Delta_Dsink]).T
#df_Delta_Dsink.columns = ['x1','Delta_Dsink_tvent1']
df_Delta_Dsink.columns = ['x1','Delta_Dsink_tempconst']

df_Pgrow = pd.DataFrame(data=[x1, Pgrow]).T
df_Pgrow.columns = ['x1','Pgrow_tempconst']

df_Pgraz = pd.DataFrame(data=[x1, Pgraz]).T
df_Pgraz.columns = ['x1','Pgraz_tempconst']

df_Pmort = pd.DataFrame(data=[x1, Pmort]).T
df_Pmort.columns = ['x1','Pmort_tempconst']

df_Pmort2 = pd.DataFrame(data=[x1, Pmort2]).T
df_Pmort2.columns = ['x1','Pmort2_tempconst']

df_Pmix = pd.DataFrame(data=[x1, Pmix]).T
df_Pmix.columns = ['x1','Pmix_tempconst']

df_Pdilute = pd.DataFrame(data=[x1, Pdilute]).T
df_Pdilute.columns = ['x1','Pdilute_tempconst']

df_Nmix = pd.DataFrame(data=[x1, Nmix]).T
df_Nmix.columns = ['x1','Nmix_tempconst']

df_Zexc = pd.DataFrame(data=[x1, Zexc]).T
df_Zexc.columns = ['x1','Zexc_tempconst']

df_Dremin_src = pd.DataFrame(data=[x1, Dremin_src]).T
df_Dremin_src.columns = ['x1','Dremin_src_tempconst']

df_Pgrow_sink = pd.DataFrame(data=[x1, Pgrow_sink]).T
df_Pgrow_sink.columns = ['x1','Pgrow_sink_tempconst']

df_Nadd = pd.DataFrame(data=[x1, Nadd]).T
df_Nadd.columns = ['x1','Nadd_tempconst']

df_Ndilute = pd.DataFrame(data=[x1, Ndilute]).T
df_Ndilute.columns = ['x1','Ndilute_tempconst']

df_Zgrow = pd.DataFrame(data=[x1, Zgrow]).T
df_Zgrow.columns = ['x1','Zgrow_tempconst']

df_Zmort = pd.DataFrame(data=[x1, Zmort]).T
df_Zmort.columns = ['x1','Zmort_tempconst']

df_Zmort2 = pd.DataFrame(data=[x1, Zmort2]).T
df_Zmort2.columns = ['x1','Zmort2_tempconst']

df_Zdilute = pd.DataFrame(data=[x1, Zdilute]).T
df_Zdilute.columns = ['x1','Zdilute_tempconst']

df_Zmix = pd.DataFrame(data=[x1, Zmix]).T
df_Zmix.columns = ['x1','Zmix_tempconst']

df_Pmort_src = pd.DataFrame(data=[x1, Pmort_src]).T
df_Pmort_src.columns = ['x1','Pmort_src_tempconst']

df_Pmort2_src = pd.DataFrame(data=[x1, Pmort2_src]).T
df_Pmort2_src.columns = ['x1','Pmort2_src_tempconst']

df_Zmort_src = pd.DataFrame(data=[x1, Zmort_src]).T
df_Zmort_src.columns = ['x1','Zmort_src_tempconst']

df_Zpel = pd.DataFrame(data=[x1, Zpel]).T
df_Zpel.columns = ['x1','Zpel_tempconst']

df_Dgraz = pd.DataFrame(data=[x1, Dgraz]).T
df_Dgraz.columns = ['x1','Dgraz_tempconst']

df_Dmix = pd.DataFrame(data=[x1, Dmix]).T
df_Dmix.columns = ['x1','Dmix_tempconst']

df_Dsink = pd.DataFrame(data=[x1, Dsink]).T
df_Dsink.columns = ['x1','Dsink_tempconst']

df_Dremin = pd.DataFrame(data=[x1, Dremin]).T
df_Dremin.columns = ['x1','Dremin_tempconst']

df_Ddilute = pd.DataFrame(data=[x1, Ddilute]).T
df_Ddilute.columns = ['x1','Ddilute_tempconst']

df_Pgrow_sum = pd.DataFrame(data=[x1, Pgrow_sum]).T
#df_Pgrow_sum.columns = ['x1','Pgrow_sum_tvent1']
df_Pgrow_sum.columns = ['x1','Pgrow_sum_tempconst']

df_Zgrow_sum = pd.DataFrame(data=[x1, Zgrow_sum]).T
#df_Zgrow_sum.columns = ['x1','Zgrow_sum_tvent1']
df_Zgrow_sum.columns = ['x1','Zgrow_sum_tempconst']

df_Dremin_sum = pd.DataFrame(data=[x1, Dremin_sum]).T
#df_Dremin_sum.columns = ['x1','Dremin_sum_tvent1']
df_Dremin_sum.columns = ['x1','Dremin_sum_tempconst']

df_Nmix_sum = pd.DataFrame(data=[x1, Nmix_sum]).T
#df_Nmix_sum.columns = ['x1','Nmix_sum_tvent1']
df_Nmix_sum.columns = ['x1','Nmix_sum_tempconst']

df_Pmix_sum = pd.DataFrame(data=[x1, Pmix_sum]).T
#df_Pmix_sum.columns = ['x1','Pmix_sum_tvent1']
df_Pmix_sum.columns = ['x1','Pmix_sum_tempconst']

df_Zmix_sum = pd.DataFrame(data=[x1, Zmix_sum]).T
#df_Zmix_sum.columns = ['x1','Zmix_sum_tvent1']
df_Zmix_sum.columns = ['x1','Zmix_sum_tempconst']

df_Dmix_sum = pd.DataFrame(data=[x1, Dmix_sum]).T
#df_Dmix_sum.columns = ['x1','Dmix_sum_tvent1']
df_Dmix_sum.columns = ['x1','Dmix_sum_tempconst']

df_Dsink_sum = pd.DataFrame(data=[x1, Dsink_sum]).T
#df_Dsink_sum.columns = ['x1','Dsink_sum_tvent1']
df_Dsink_sum.columns = ['x1','Dsink_sum_tempconst']

df_t_vent1_phys = pd.DataFrame(data=[x2, t_vent1_phys]).T
df_t_vent1_phys.columns = ['x2','t_vent1_phys_tempconst']

df_t_vent2_phys = pd.DataFrame(data=[x2, t_vent2_phys]).T
df_t_vent2_phys.columns = ['x2','t_vent2_phys_tempconst']
...
df_Delta_Id_DIC.to_csv("Results/Delta_Id_DIC_tempconst.csv", index=None)

df_Delta_Im_DIC.to_csv("Results/Delta_Im_DIC_tempconst.csv", index=None)

df_Delta_Iab_DIC.to_csv("Results/Delta_Iab_DIC_tempconst.csv", index=None)

df_Delta_Im_DIC_bio.to_csv("Results/Delta_Im_DIC_bio_tempconst.csv", index=None)

df_Delta_Id_DIC_bio.to_csv("Results/Delta_Id_DIC_bio_tempconst.csv", index=None)

df_Delta_Iab_DIC_bio.to_csv("Results/Delta_Iab_DIC_bio_tempconst.csv", index=None)

df_Ibelow_DOC.to_csv("Results/Ibelow_DOC_tempconst.csv", index=None)

df_Delta_Ibelow_DOC.to_csv("Results/Delta_Ibelow_DOC_tempconst.csv", index=None)

df_Im_DOC.to_csv("Results/Im_DOC_tempconst.csv", index=None)

df_Delta_Im_DOC.to_csv("Results/Delta_Im_DOC_tempconst.csv", index=None)

df_Delta_I_DOC.to_csv("Results/Delta_I_DOC_tempconst.csv", index=None)

df_Delta_I_DIC.to_csv("Results/Delta_I_DIC_tempconst.csv", index=None)

#df_Ia.to_csv("Results/Ia_tvent1.csv", index=None)
#df_Ia.to_csv("Results/Ia_tvent2.csv", index=None)
df_Delta_Ia.to_csv("Results/Delta_Ia_tempconst.csv", index=None)

df_delta_temp.to_csv("Results/delta_temp_tempconst.csv", index=None)

#df_dic_m.to_csv("Results/dic_m_tvent1.csv", index=None)
#df_dic_m.to_csv("Results/dic_m_tvent2.csv", index=None)
df_dic_m.to_csv("Results/dic_m_tempconst.csv", index=None)

#df_dic_d.to_csv("Results/dic_d_tvent1.csv", index=None)
#df_dic_d.to_csv("Results/dic_d_tvent2.csv", index=None)
df_dic_d.to_csv("Results/dic_d_tempconst.csv", index=None)

df_dic_ab.to_csv("Results/dic_ab_tempconst.csv", index=None)

#df_DTa.to_csv("Results/DTa_tvent1.csv", index=None)
#df_DTa.to_csv("Results/DTa_tvent2.csv", index=None)
df_DTa.to_csv("Results/DTa_tempconst.csv", index=None)

#df_DTm.to_csv("Results/DTm_tvent1.csv", index=None)
#df_DTm.to_csv("Results/DTm_tvent2.csv", index=None)
df_DTm.to_csv("Results/DTm_tempconst.csv", index=None)

#df_DTd.to_csv("Results/DTd_tvent1.csv", index=None)
#df_DTd.to_csv("Results/DTd_tvent2.csv", index=None)
df_DTd.to_csv("Results/DTd_tempconst.csv", index=None)

df_DTab.to_csv("Results/DTab_tempconst.csv", index=None)

#df_Delta_Pgrow.to_csv("Results/Delta_Pgrow_tvent1.csv", index=None)
df_Delta_Pgrow.to_csv("Results/Delta_Pgrow_tempconst.csv", index=None)

#df_Delta_Zgrow.to_csv("Results/Delta_Zgrow_tvent1.csv", index=None)
df_Delta_Zgrow.to_csv("Results/Delta_Zgrow_tempconst.csv", index=None)

#df_Delta_Dremin.to_csv("Results/Delta_Dremin_tvent1.csv", index=None)
df_Delta_Dremin.to_csv("Results/Delta_Dremin_tempconst.csv", index=None)

#df_Delta_Pmix.to_csv("Results/Delta_Pmix_tvent1.csv", index=None)
df_Delta_Pmix.to_csv("Results/Delta_Pmix_tempconst.csv", index=None)

#df_Delta_Zmix.to_csv("Results/Delta_Zmix_tvent1.csv", index=None)
df_Delta_Zmix.to_csv("Results/Delta_Zmix_tempconst.csv", index=None)

#df_Delta_Nmix.to_csv("Results/Delta_Nmix_tvent1.csv", index=None)
df_Delta_Nmix.to_csv("Results/Delta_Nmix_tempconst.csv", index=None)

#df_Delta_Dmix.to_csv("Results/Delta_Dmix_tvent1.csv", index=None)
df_Delta_Dmix.to_csv("Results/Delta_Dmix_tempconst.csv", index=None)

#df_Delta_Dsink.to_csv("Results/Delta_Dsink_tvent1.csv", index=None)
df_Delta_Dsink.to_csv("Results/Delta_Dsink_tempconst.csv", index=None)

df_Pgrow.to_csv("Results/Pgrow_tempconst.csv", index=None)

df_Pgraz.to_csv("Results/Pgraz_tempconst.csv", index=None)

df_Pmort.to_csv("Results/Pmort_tempconst.csv", index=None)

df_Pmort2.to_csv("Results/Pmort2_tempconst.csv", index=None)

df_Pmix.to_csv("Results/Pmix_tempconst.csv", index=None)

df_Pdilute.to_csv("Results/Pdilute_tempconst.csv", index=None)

df_Nmix.to_csv("Results/Nmix_tempconst.csv", index=None)

df_Zexc.to_csv("Results/Zexc_tempconst.csv", index=None)

df_Dremin_src.to_csv("Results/Dremin_src_tempconst.csv", index=None)

df_Pgrow_sink.to_csv("Results/Pgrow_sink_tempconst.csv", index=None)

df_Nadd.to_csv("Results/Nadd_tempconst.csv", index=None)

df_Ndilute.to_csv("Results/Ndilute_tempconst.csv", index=None)

df_Zgrow.to_csv("Results/Zgrow_tempconst.csv", index=None)

df_Zmort.to_csv("Results/Zmort_tempconst.csv", index=None)

df_Zmort2.to_csv("Results/Zmort2_tempconst.csv", index=None)

df_Zdilute.to_csv("Results/Zdilute_tempconst.csv", index=None)

df_Zmix.to_csv("Results/Zmix_tempconst.csv", index=None)

df_Pmort_src.to_csv("Results/Pmort_src_tempconst.csv", index=None)

df_Pmort2_src.to_csv("Results/Pmort2_src_tempconst.csv", index=None)

df_Zmort_src.to_csv("Results/Zmort_src_tempconst.csv", index=None)

df_Zpel.to_csv("Results/Zpel_tempconst.csv", index=None)

df_Dgraz.to_csv("Results/Dgraz_tempconst.csv", index=None)

df_Dmix.to_csv("Results/Dmix_tempconst.csv", index=None)

df_Dsink.to_csv("Results/Dsink_tempconst.csv", index=None)

df_Dremin.to_csv("Results/Dremin_tempconst.csv", index=None)

df_Ddilute.to_csv("Results/Ddilute_tempconst.csv", index=None)

#df_Pgrow_sum.to_csv("Results/Pgrow_sum_tvent1.csv", index=None)
df_Pgrow_sum.to_csv("Results/Pgrow_sum_tempconst.csv", index=None)

#df_Zgrow_sum.to_csv("Results/Zgrow_sum_tvent1.csv", index=None)
df_Zgrow_sum.to_csv("Results/Zgrow_sum_tempconst.csv", index=None)

#df_Dremin_sum.to_csv("Results/Dremin_sum_tvent1.csv", index=None)
df_Dremin_sum.to_csv("Results/Dremin_sum_tempconst.csv", index=None)

#df_Pmix_sum.to_csv("Results/Pmix_sum_tvent1.csv", index=None)
df_Pmix_sum.to_csv("Results/Pmix_sum_tempconst.csv", index=None)

#df_Zmix_sum.to_csv("Results/Zmix_sum_tvent1.csv", index=None)
df_Zmix_sum.to_csv("Results/Zmix_sum_tempconst.csv", index=None)

#df_Nmix_sum.to_csv("Results/Nmix_sum_tvent1.csv", index=None)
df_Nmix_sum.to_csv("Results/Nmix_sum_tempconst.csv", index=None)

#df_Dmix_sum.to_csv("Results/Dmix_sum_tvent1.csv", index=None)
df_Dmix_sum.to_csv("Results/Dmix_sum_tempconst.csv", index=None)

#df_Dsink_sum.to_csv("Results/Dsink_sum_tvent1.csv", index=None)
df_Dsink_sum.to_csv("Results/Dsink_sum_tempconst.csv", index=None)

df_t_vent1_phys.to_csv("Results/t_vent1_phys_tempconst.csv", index=None)

df_t_vent2_phys.to_csv("Results/t_vent2_phys_tempconst.csv", index=None)
